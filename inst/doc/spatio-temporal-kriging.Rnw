...
\title{Spatio-Temporal Geostatistics using \pkg{gstat}}
...
\begin{table}
\caption{Leave one out cross-validation results: root mean squared error (RMSE), mean absolute error (MAE), mean error (ME) and correlation (COR).}\label{tab:cv}
\centering
\begin{tabular}{lrr|rrrr}
covariance model & wMSE & neigh. &  RMSE   &   MAE   &    ME   &   COR \\ \hline
pure Spatial & & 10 & 6.15 & 4.09 & -0.01 & 0.84  \\ 
separable &\hspace{-\tabcolsep}[6.82]&     10 &  6.10 & 4.06 & -0.02 & 0.84  \\ 
product-sum &\hspace{-\tabcolsep}[6.88]& 10 &  6.10 & 4.06 & -0.02 & 0.84  \\ 
metric &\hspace{-\tabcolsep}[10.05]&          10 &   6.13 & 4.08 & 0.02 & 0.84  \\ 
sum-metric &\hspace{-\tabcolsep}[3.31]&   10 &  6.17 & 4.08 & -0.07 & 0.84  \\ 
simple sum-metric &\hspace{-\tabcolsep}[3.31]& 10  &  6.17 & 4.08 & -0.07 & 0.84  \\   \hline
pure Spatial & & 50 & 6.10 & 4.07 & 0.00 & 0.84  \\ 
separable &\hspace{-\tabcolsep}[6.82]& 50     & 6.05 & 4.04 & 0.01 & 0.84  \\ 
product-sum &\hspace{-\tabcolsep}[6.88]& 50 &   6.05 & 4.04 & 0.00 & 0.84  \\ 
metric &\hspace{-\tabcolsep}[10.05]& 50          &  6.07 & 4.08 & 0.03 & 0.84  \\ 
sum-metric &\hspace{-\tabcolsep}[3.31]& 50   &  6.14 & 4.09 & -0.01 & 0.84  \\ 
simple sum-metric &\hspace{-\tabcolsep}[3.31]& 50 &  6.14 & 4.09 & -0.01 & 0.84
\end{tabular}
\end{table}
